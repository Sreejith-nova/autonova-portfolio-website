...
export const CreativesGallery = memo(function CreativesGallery() {
	...
	useEffect(() => {
		setIsModalOpen(Boolean(lightboxAsset));
		return () => {
			setIsModalOpen(false);
		};
	}, [lightboxAsset, setIsModalOpen]);
		...
		<Section className="bg-background relative z-10 min-h-screen">
			<Container>
				...
				<div id="ours" className="mb-32 md:mb-48 scroll-mt-32">
					...
					<MasonryGallery items={ourAssets} onAssetClick={setLightboxAsset} />
				</div>
				...
				<div id="client" className="mb-20 scroll-mt-32">
					<div className="flex flex-col md:flex-row md:items-end justify-between mb-12 md:mb-16 gap-6">
						...
						>
							<Text className="text-base text-subtle/80">
								Selected commercial campaign deliverables and high-fidelity
								production assets.
							</Text>
						</motion.div>
					</div>
